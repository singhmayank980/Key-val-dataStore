...
d={} #dictionary for storing the key value pairs
...
def create(key,value,timeout=0):
    if key in d:
        ...
        if(key.isalpha()):
            if len(d)<(1024*1020*1024) and value<=(16*1024*1024): #ensure that the file size less than 1GB and Jasonobject value less than 16KB 
                if timeout==0:
                    l=[value,timeout]
                else:
                ...
                print("Sorry , Memory exceeds !! ")#error message2
        else:
